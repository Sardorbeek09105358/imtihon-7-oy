          ...
          <div className='flex justify-center items-center w-full mb-16'>
            <div className='flex justify-between w-[95%] items-center'>
              <div className=' flex flex-col pt-[200px] w-[25%]'>
                <h1 className='capitalize mb-2 text-[25px] font-normal'>clothes</h1>
                ...
                <div className='mt-3'>
                  ...
                  <div className='w-[250px] grid grid-cols-4 gap-5'>
                    <button className='w-[60px] border-2 rounded border-[#555] uppercase '>xxs</button>
                    <button className='w-[60px] border-2 rounded border-[#555] uppercase '>xs</button>
                    <button className='w-[60px] border-2 rounded border-[#555] uppercase '>s</button>
                    <button className='w-[60px] border-2 rounded border-[#555] uppercase '>m</button>
                    <button className='w-[60px] border-2 rounded border-[#555] uppercase '>l</button>
                    <button className='w-[60px] border-2 rounded border-[#555] uppercase  bg-[#ED165F]'>xl</button>
                    <button className='w-[60px] border-2 rounded border-[#555] uppercase '>23</button>
                    <button className='w-[60px] border-2 rounded border-[#555] uppercase '>24</button>
                    <button className='w-[60px] border-2 rounded border-[#555] uppercase '>25</button>
                    <button className='w-[60px] border-2 rounded border-[#555] uppercase '>26</button>
                    <button className='w-[60px] border-2 rounded border-[#555] uppercase '>27</button>
                    <button className='w-[60px] border-2 rounded border-[#555] uppercase '>28</button>
                    <button className='w-[60px] border-2 rounded border-[#555] uppercase '>28</button>
                    <button className='w-[60px] border-2 rounded border-[#555] uppercase '>29</button>
                    <button className='w-[60px] border-2 rounded border-[#555] uppercase '>30</button>
                    <button className='w-[60px] border-2 rounded border-[#555] uppercase  bg-[#ED165F]'>31</button>
                  </div>
                </div>
