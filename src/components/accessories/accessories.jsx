          ...
          <div className='flex justify-center items-center w-full mb-16'>
            <div className='flex justify-between w-[95%] items-center'>
              <div className=' flex flex-col pt-[200px] w-[25%]'>
                <h1 className='capitalize mb-2 text-[25px] font-normal'>accesories</h1>
                <hr className='w-[400px] h-5' />
                <div className=''>
                  <h1 className='capitalize text-[#777] text-[22px] mb-2'>all</h1>
                  <h1 className='capitalize text-[#777] text-[22px] mb-2'>facemask</h1>
                  <h1 className='capitalize text-[#777] text-[22px] mb-2'>jewelry</h1>
                  <h1 className='capitalize text-[#777] text-[22px] mb-2'>watches</h1>
                  <h1 className='capitalize text-[#777] text-[22px] mb-2'>hair accesoies</h1>
                  <h1 className='capitalize text-[#777] text-[22px] mb-2'>belts</h1>
                  ...
                  <h1 className='capitalize text-[#777] text-[22px] mb-2'>hats and beans</h1>
                  <h1 className='capitalize text-[#777] text-[22px] mb-2'>glowes</h1>
                </div>
                <div className='mt-3'>
                  <h1 className='mb-3 capitalize text-[30px]'>size</h1>
                  <div className='h-[2px] mb-3 bg-[#999] w-[80%]'></div>
                  <div className='w-[250px] grid grid-cols-4 gap-10'>
                    <button className='w-[65px] h-[32px] border-2 rounded border-[#555] uppercase '>xs</button>
                    <button className='w-[65px] h-[32px] border-2 rounded border-[#555] uppercase '>s</button>
                    <button className='w-[65px] h-[32px] border-2 rounded border-[#555] uppercase '>s/m</button>
                    <button className='w-[65px] h-[32px] border-2 rounded border-[#555] uppercase '>m/l</button>
                    <button className='w-[65px] h-[32px] border-2 rounded border-[#555] uppercase bg-[#ED165F]'>l</button>
                    <button className='w-[65px] h-[32px] border-2 rounded border-[#555] uppercase '>xl</button>
                    <button className='w-[65px] h-[32px] border-2 rounded border-[#555] uppercase '>6</button>
                    <button className='w-[65px] h-[32px] border-2 rounded border-[#555] uppercase '>7</button>
                    <button className='w-[65px] h-[32px] border-2 rounded border-[#555] uppercase '>8</button>
                  </div>
                </div>
              ...
              <div className='w-[70%]'>
                ...
                <div className='text-center mx-auto flex flex-col items-center pt-[300px]'>
                  ...
                  <div className="flex gap-5 justify-center items-center">
                    <button className='w-12 h-8 cursor-pointer border-2 border-red-200 my-2 mx-2' disabled={disPrev} onClick={prev} >1</button>
                    <button className='w-12 h-8 cursor-pointer border-2 border-red-200 my-2 mx-2' disabled={disNext} onClick={next}>2</button>
